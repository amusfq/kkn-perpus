...
export default function CreateUpdatePublisher({}: Props) {
  ...
  const getData = async (id?: string) => {
    ...
    await Axios.get(`/publisher/${id}`)
      ...
      .catch((err) => {
        ...
        toast.error("Gagal mengambil data Penerbit  ", { theme: "colored" });
      })
      .finally(() => {
        setIsLoading(false);
      });
  ...
  const onSubmit = (data: any) => {
    setIsLoading(true);
    if (id) {
      Axios.put(`/publisher/${id}`, data)
        .then(() => {
          Swal.fire({
            title: "Penerbit berhasil diubah",
            icon: "success",
      ...
      Axios.post("/publisher", data)
        .then(() => {
          Swal.fire({
            title: "Penerbit berhasil diinput",
            icon: "success",
